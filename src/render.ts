...
// 全局配置存储
let globalConfig: RenderConfigOptions = {}
 ...
 */
export function configure(config: RenderConfigOptions): void {
  globalConfig = { ...globalConfig, ...config }
  console.log('[jsxp] 渲染配置已更新:', globalConfig)
}
 ...
 */
export function getConfig(): RenderConfigOptions {
  return { ...globalConfig }
}
...
export const render = async (
  ...
  PupOptions?: PupOptions,
  config?: RenderConfigOptions
): Promise<any> => {
  // 合并全局配置和本次调用的配置
