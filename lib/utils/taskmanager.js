...
function findAndLockReusableFile(targetDir) {
    try {
        ...
        for (const fileInfo of fileInfos) {
            ...
            // 原子检查：一次性检查所有条件并立即锁定
            if (!taskMap.has(taskId) && // 任务不在活跃任务中
...
export { cleanupCompletedFiles, cleanupTask, createTask, findAndLockReusableFile, releaseReusableLock, startCleanupTimer, taskMap };
